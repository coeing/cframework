...
template < class Enum >
void CFoundation::EventDispatcher< Enum >::DispatchEvent( Enum _eEvent )
{
...
template < class Enum >
void CFoundation::EventDispatcher< Enum >::RegisterCallback( Enum _eEvent, CallbackBasePtr _pCallback )
{
    CallbackVector* pCallbacks = GetCallbacks( _eEvent );
    if ( pCallbacks == NULL )
    {
...
template < class Enum >
void CFoundation::EventDispatcher< Enum >::RemoveCallback( Enum _eEvent, CallbackBasePtr _pCallback )
{
    CallbackVector* pCallbacks = GetCallbacks( _eEvent );
    if ( pCallbacks == NULL )
    {
