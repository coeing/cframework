#ifndef CFOUNDATION_RECT_H
#define CFOUNDATION_RECT_H
...
namespace CFoundation
{
	...
	public:
        ...
        /// Sets the width
        void                    SetWidth( T _tWidth );

        /// Sets the height
        void                    SetHeight( T _tHeight );
        ...
        void                    SetSize( const Vector2D< T >& _vSize );
		...
		BorderType              GetBordersPointIsOn( const Vector2D< T > _tPos, T _tBorderWidth ) const;
