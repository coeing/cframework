...
void Xerces::XMLDocument::InsertChildFirst( CFoundation::XMLNode &clChildNode )
{
    m_pNode->InsertChildFirst( clChildNode );
}

void Xerces::XMLDocument::InsertChildBefore( CFoundation::XMLNode &clChildNode, CFoundation::XMLNode &clBefore )
{
    m_pNode->InsertChildBefore( clChildNode, clBefore );
}

void Xerces::XMLDocument::InsertChildAfter( CFoundation::XMLNode &clChildNode, CFoundation::XMLNode &clAfter )
{
    m_pNode->InsertChildAfter( clChildNode, clAfter );
}

void Xerces::XMLDocument::InsertChildLast( CFoundation::XMLNode& _clChildNode )
{
...
CFoundation::XMLElementPtr Xerces::XMLDocument::GetRootElement() const
{
    return m_spRootElement;
}

CFoundation::XMLElementPtr Xerces::XMLDocument::CreateElement( const CFoundation::String& _sName )
{
...
CFoundation::XMLTextPtr Xerces::XMLDocument::CreateText( const CFoundation::String &sText )
{
...
void Xerces::XMLDocument::Refine( CFoundation::XMLNodePtr _pNode, Unsigned32 u32Level )
{
	if( _pNode != NULL &&
        _pNode->IsValid() )
	{
