...
void Xerces::XMLElement::InsertChildFirst( CFoundation::XMLNode &clChildNode )
{
    m_pNode->InsertChildFirst( clChildNode );
}

void Xerces::XMLElement::InsertChildBefore( CFoundation::XMLNode &clChildNode, CFoundation::XMLNode &clBefore )
{
    m_pNode->InsertChildBefore( clChildNode, clBefore );
}

void Xerces::XMLElement::InsertChildAfter( CFoundation::XMLNode &clChildNode, CFoundation::XMLNode &clAfter )
{
    m_pNode->InsertChildAfter( clChildNode, clAfter );
}

void Xerces::XMLElement::InsertChildLast( CFoundation::XMLNode &clChildNode )
{
