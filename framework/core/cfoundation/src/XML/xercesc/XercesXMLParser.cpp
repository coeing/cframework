...
CFoundation::XMLDocumentPtr Xerces::XMLParser::ParseFile( const CFoundation::String& _sFileName )
{
    ...
    {
        CO_WARN( L"An error occurred during parsing\n   Message: %s", CFoundation::String( XMLString::transcode(e.getMessage()) ).wc_str() );
        errorsOccured = true;
    }
...
CFoundation::XMLDocumentPtr Xerces::XMLParser::CreateDocument()
{
    return XMLDocumentPtr( new XMLDocument() );
}
            
CFoundation::XMLDocumentPtr Xerces::XMLParser::CreateDocument( const String& _sRootName )
{
    return XMLDocumentPtr( new XMLDocument( _sRootName ) );
}

bool Xerces::XMLParser::WriteFile( CFoundation::XMLDocumentCPtr _spDocument, const CFoundation::String &sFileName )
{
	if( sFileName == "" )
	{
		return false;
