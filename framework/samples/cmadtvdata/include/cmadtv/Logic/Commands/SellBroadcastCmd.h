#ifndef CMADTV_SELL_BROADCAST_CMD_H
#define CMADTV_SELL_BROADCAST_CMD_H
...
namespace CMadTV
{
    ...
    class SellBroadcastCmd : public PlayerCommand
    {
    public:
        /// Error codes
        enum Error
        ...
        /// Constructor
        SellBroadcastCmd( PlayerContextPtr _spContext = PlayerContextPtr(), BroadcastPtr _spBroadcast = BroadcastPtr() );
    ...
    INCLUDE_SHARED_CLASS( SellBroadcastCmd );
}
