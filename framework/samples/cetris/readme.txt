...
path 'projects/visualc/cframework/cetris'.
...
Left/Right	Move blocks left/right

A/S		Rotate blocks counter-clockwise/clockwise

The more rows you erase with one block, the more points you
will get. After some rows the level will raise and the blocks
