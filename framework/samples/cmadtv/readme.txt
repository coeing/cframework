...
Just open the solution file with Visual Studio 2008 
(2005 may work, but wasn't tested) and build the project.

You can find the solution file in this package under the
path 'projects/visualc/cframework/cmadtv.sln'.
