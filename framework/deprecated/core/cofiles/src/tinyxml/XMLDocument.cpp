#include "cofiles/tinyxml/XMLDocument.h"

#include "cofiles/tinyxml/XMLElement.h"
...
XMLElement	XMLDocument::CreateElement( const CoFiles::String &sName )
{
...
XMLText	XMLDocument::CreateText( const CoFiles::String &sText )
{
    XMLText clNewText;
